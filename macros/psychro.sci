...
function [Tdry,Twet,Tdew,Tadiab,W,Wsat,Wsatwet,Wadiab,h,v,phi,pw,psat,psatwet,rho]=psychro(Tdry,Twet,Tdew,W,h,v,phi,fig)
    ...
    // Tdry1=293
    // Twet1=288
    // [Tdry1,Twet1,Tdew1,Tadiab1,W1,Wsat1,Wsatwet1,Wadiab1,h1,v1,phi1,pw1,psat1,psatwet1,rho1]=psychro(Tdry=Tdry1,Twet=Twet1,fig=%t)
    //
    // // The thermodynamic state the after first adiabatic saturation is
    // Tdry2=323
    // W2=W1
    // [Tdry2,Twet2,Tdew2,Tadiab2,W2,Wsat2,Wsatwet2,Wadiab2,h2,v2,phi2,pw2,psat2,psatwet2,rho2]=psychro(Tdry=Tdry2,W=W2,fig=%t)
    // // The thermodynamic state the after first adiabatic saturation is
    // h3=h2
    ...
    // Tdry4=323
    // W4=W3
    // [Tdry4,Twet4,Tdew4,Tadiab4,W4,Wsat4,Wsatwet4,Wadiab4,h4,v4,phi4,pw4,psat4,psatwet4,rho4]=psychro(Tdry=Tdry4,W=W4,fig=%t)
